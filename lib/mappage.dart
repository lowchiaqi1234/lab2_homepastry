...
import 'package:homepastry/delivery.dart';
...
class _MappageState extends State<Mappage> {
  ...
  void showShopMarker() {
    MarkerId markerId1 = MarkerId("17");
    markers.add(Marker(
      markerId: markerId1,
      position: LatLng(5.3807122262864535, 100.47442568855797),
      infoWindow: InfoWindow(
        title: 'Shop Location',
        snippet: "Home Partry Market",
      ),
  ...
  double calculateDistance(lat1, lon1) {
    var lat2 = 5.3807122262864535;
    var lon2 = 100.47442568855797;
