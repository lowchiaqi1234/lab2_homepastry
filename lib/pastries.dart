...
class Patries extends StatefulWidget {
  ...
  const Patries({Key key, this.user}) : super(key: key);
  @override
  _PatriesState createState() => _PatriesState();
}

class _PatriesState extends State<Patries> {double screenHeight, screenWidth;
...
int cartitem = 0;
  ...
  void _loadproduct() {
     http.post(
        Uri.parse("https://lowtancqx.com/s270910/homepastry/php/loadpastries.php"),
        body: {}).then((response) {
